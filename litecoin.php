...
<meta charset="utf-8">
        ...
        <link rel="stylesheet" href="css/mainblue2.css">
		<link rel="stylesheet" href="css/themes/blue3.css" id="theme-link">
                            ...
                            <div class="col-sm-12">
                                <div class="page-title-box">
                                    <ol class="breadcrumb pull-right">
                                        ...
                                        <li class="active">Litecoin</li>
                                    </ol>
                                    <h4 class="page-title">Litecoin</h4>
                                </div>
                            </div>
                        </div>
...
<center><div class="col-lg-6">
                                ...
                                <div class="card-box">
                                    <h4 class="text-dark  header-title m-t-0"><?php echo $row['name']; ?> - Litecoin Checkout</h4>
                                    <p class="text-muted m-b-25 font-13">
                                        
                                    </p>

                                    <div class="table-responsive">
                                        Please send <b><?php echo $row['price']; ?></b>€ to <input class="form-control" id="host" style="margin-top: 10px;" value="MHarWVdrCtQRY8knHkx2owx3MBUn5eSd7E" type="text" readonly> <br/> <b>TAX INCLUDED ONLY </b>and after open a ticket with bitcoin transation link or screenshot of payment
										<br/>
										<br/>
