...
<body background="http://i.imgur.com/BXT2cft.jpg">
...
<a href="login.php" class="btn btn-effect-ripple btn-primary" data-toggle="tooltip" data-placement="left" title="Back to login">Login <i class="fa fa-user"></i></a>
</div>
