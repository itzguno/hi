...
<!--[if gt IE 9]><!--> <html class="no-js"> <!--<![endif]-->
 ...
 <div class="alert alert-warning alert-dismissable animation-bigEntrance"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button><strong>Warning: </strong>This ticket is on hold status, an administrator will answer you as soon as possible.</div>
 		<?php } ?>
<div id="page-content-sidebar">
 
<div class="block-section">
<a href="#modal-compose" class="btn btn-effect-ripple btn-block btn-success" data-toggle="modal"><i class="fa fa-envelope sidebar-nav-icon"></i> New Ticket</a>
</div>
